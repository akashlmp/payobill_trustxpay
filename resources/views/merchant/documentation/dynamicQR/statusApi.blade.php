...
<head>
    ...
    <title>{{ config('app.name') }} | Retailer | Dynamic QR Payin Status API</title>
                ...
                <div class="row bg-custom">
                    <div class="col-lg-12 left__section">
                        <div class="d-flex  justify-content-start align-items-center">
                            <span class="fw-bold text-dark ms-2 " style="font-size: 40px;"> Dynamic QR Payin Status API</span>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row m-0">
                                    <div class="col-md-12 custom-div">
                                        ...
                                        <section class="mt-4">
                                            ...
                                            <p><b>Request Endpoint:</b> <code>{{env('APP_URL')}}/api/prod-mode/payin-dynamic-qr/status</code></p>
                                        </section>
