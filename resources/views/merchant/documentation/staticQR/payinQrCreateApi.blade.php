                ...
                <div class="row bg-custom">
                    <div class="col-lg-12 left__section">
                        <div class="d-flex  justify-content-start align-items-center">
                            <span class="fw-bold text-dark ms-2 " style="font-size: 40px;"> Create Static QR API</span>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="row m-0">
                                    <div class="col-md-12 custom-div">
                                        ...
                                        <section class="mt-2">
                                            <h4>Introduction</h4>
                                            <p>This document provides how to integrate trustxpay create static QR API.</p>
                                        </section>
                                        ...
                                        <section class="mt-4">
                                            ...
                                            <p><b>Request Endpoint:</b> <code>{{env('APP_URL')}}/api/prod-mod/payin-static-qr/create</code></p>
                                        </section>
