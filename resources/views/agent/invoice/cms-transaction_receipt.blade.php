...
<div style="border: 1px solid #333; margin: 50px auto; width: 80%;" id="inv">
    <div style=" display:flex;
        ...
        <div style="width: 33%;text-align: center;" id="invh">
            <h1 style="margin: 0px; padding: 0px 20px;font-size:2em;font-weight:bold">Invoice</h1>
            <p style="margin: 0px; padding: 0px 20px; margin-bottom: 2px;">{{date('d-m-Y h:i:s',strtotime($created_at))}}</p>
        </div>
    ...
    <div
        ...
        @if($provider_name =='Money Transfer')
            <div style="border:1px solid #ddd; border-radius:4px; width: 31%;" id="width">
                <h3 style="padding: 8px 10px; background-color: #808080; color: #fff; text-transform: capitalize; margin: 0px;"
                    class="spac">
                    customer details</h3>
                <div style="padding:20px; text-transform: capitalize;" class="spac">
                    ...
                    <p style="margin: 0px; margin-bottom: 8px;" id="ptag"><b>Remitter number : </b>{{$remiter_number}}
                    </p>
            ...
            <div style="border:1px solid #ddd; border-radius:4px; width: 31%;" id="width">
                ...
                <div style="padding:20px; text-transform: capitalize;" class="spac">
                    ...
                    <p style="margin: 0px; margin-bottom: 8px;" id="ptag"><b>account number : </b>{{ $account_number }}
                    </p>
        ...
        <table style="width: 100%; border: 1px solid #ddd; border-collapse: collapse;">
            <tr>
                <th style="background-color: #333;padding: 10px; text-align: center; color: #fff; text-transform: capitalize;width: 20%;"
                    class="spac">Transaction Id
                </th>
                <th style="background-color: #333;padding: 10px; text-align: center; color: #fff; text-transform: capitalize; width: 20%;"
                    class="spac">Cash collected for
                </th>
                <th style="background-color: #333;padding: 10px; text-align: center; color: #fff; text-transform: capitalize; width: 20%;"
                    class="spac">Employee Id
                </th>
                <th style="background-color: #333;padding: 10px; text-align: center; color: #fff; text-transform: capitalize; width: 20%;"
                    class="spac">Partner TXN ID
                </th>
                <th style="background-color: #333;padding: 10px; text-align: center; color: #fff; text-transform: capitalize; width: 20%;"
                    class="spac">Status
                </th>
            ...
            <tr style="border-bottom: 1px solid #ddd;">
                <td style="padding: 15px 10px; text-align: center; color: #333; text-transform: capitalize; width: 20%; border-bottom: 1px solid #ddd;"
                    class="spac">{{$txnid}}</td>
                <td style="padding: 15px 10px; text-align: center; color: #333; text-transform: capitalize; width: 20%; border-bottom: 1px solid #ddd;"
                    class="spac">{{$provider_name}}</td>
                <td style="padding: 15px 10px; text-align: center; color: #333; text-transform: capitalize; width: 20%; border-bottom: 1px solid #ddd;"
                    class="spac">{{$payid}}</td>
                <td style="padding: 15px 10px; text-align: center; color: #333; text-transform: capitalize; width: 20%; border-bottom: 1px solid #ddd;"
                    class="spac">{{$number}}</td>
                <td style="padding: 15px 10px; text-align: center; color: #333; text-transform: capitalize; width: 20%; border-bottom: 1px solid #ddd;"
                    class="spac">{{$status}}
                </td>
                <td style="padding: 15px 10px; text-align: center; color: #333; text-transform: capitalize; width: 20%; border-bottom: 1px solid #ddd;"
                    class="spac">
                        <span
                            style="padding:5px 10px; background-color:rgb(122, 122, 122); color:#fff; border-radius:8px;">₹{{ $amount }}</span>
                </td>
    ...
    <div
        ...
        <div style="border: 1px solid #ddd; width: 33%; margin-bottom: 10px; margin-top: 10px;" id="width">
            <h3 style="padding: 6px 10px; background-color: #808080; color: #fff; text-transform: capitalize; margin: 0px; text-align: center;font-size: 1.17em;font-weight: bold;"
                class="spac">Total Amount</h3>
            <h2 style="text-align: center; padding: 10px; margin: 0px;font-size: 1.5em;font-weight: bold;" class="spac" id="font">
                Rs. {{ $full_amount }}/-
            </h2>
            <h2 style="text-align: center; padding: 10px; margin: 0px;font-size: 1.5em;font-weight: bold;" class="spac" id="font">
...
{!! csrf_field() !!}
  ...
  <script type="text/javascript">
    ...
    function sendWhatsappMsg() {
        ...
        $.ajax({
            type: "POST",
            url: "{{url('transaction-receipt-whatsapp-msg')}}",
            data: dataString,
