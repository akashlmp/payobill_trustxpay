...
@section('content')
    <script type="text/javascript">
        ...
        function view_product(id) {
            ...
            $.ajax({
                type: "post",
                url: "{{url('agent/ecommerce-seller/view-order-product-details')}}",
                data: dataString,
        ...
        function view_update_product(id) {
            ...
            $.ajax({
                type: "post",
                url: "{{url('agent/ecommerce-seller/view-update-product')}}",
                data: dataString,
                success: function (msg) {
                    $(".loader").hide();
                    if (msg.status == 'success') {
        ...
        function update_product_status() {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('agent/ecommerce-seller/update-product-delivery-status')}}",
                data: dataString,
                success: function (msg) {
                    $("#update_btn").show();
            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('agent/ecommerce-seller/order-request')}}" method="get">
                            <div class="row">
