            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('agent/ecommerce-seller/product-list')}}" method="get">
                            <div class="row">
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{{url('agent/ecommerce-seller/add-products')}}" class="btn btn-danger btn-sm">Add New Product</a>
