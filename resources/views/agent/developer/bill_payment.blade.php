        ...
        <div class="row row-sm">
            ...
            <div class="col-lg-8 col-xl-9">
                ...
                <div class="card" id="basic-alert">
                    <div class="card-body">
                        <div>
                            <h6 class="card-title mb-1">Provider Validation</h6>
                        </div>
                        <hr>
                    ...
                    <div class="card-footer">
                        <pre>POST: {{url('api/telecom/v1/provider-validation')}}</pre>
                        <hr>
                        <pre style="color: #0ba360;">Success Response : {"status":"success","is_validation":1,"params":[{"name":"optional1","placeholder":"CA Number"}],"payment_modes":[{"mode":"Internet Banking"},{"mode":" Debit Card"},{"mode":" Credit Card"},{"mode":" Prepaid Card"},{"mode":" IMPS"},{"mode":" Cash"},{"mode":" UPI"},{"mode":" Wallet"},{"mode":" NEFT"}]}</pre>
                    </div>
                </div>
                ...
                <div class="card" id="basic-alert">
                    <div class="card-body">
                        <div>
                            <h6 class="card-title mb-1">Bill Verification</h6>
                        </div>
                        <hr>
                        ...
                        <table class="table main-table-reference mt-0 mb-0">
                            ...
                            <tr>
                                <td>optional1</td>
                                <td>the data which will need to send in optional 1, that data you will get under the params  of provider validation api</td>
                            </tr>

                            <tr>
                                <td>optional2</td>
                                <td>the data which will need to send in optional 2, that data you will get under the params  of provider validation api</td>
                            </tr>

                            <tr>
                                <td>optional3</td>
                                <td>the data which will need to send in optional 3, that data you will get under the params  of provider validation api</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
                    <div class="card-footer">
                        <pre>POST: {{url('api/telecom/v1/bill-verify')}}</pre>
                        <hr>
                        <pre style="color: #0ba360;">Success Response : {"status":"success","provider_name":"MSEDC Limited - MAHARASHTRA","number":"4745","amount":"1300","name":"{{Auth::User()->name}}","duedate":"2021-03-17","provider_id":"57","optional1":"4745","optional2":"{{Auth::User()->mobile}}","optional3":null,"optional4":12345}</pre>
                    </div>
                </div>
                ...
                <div class="card" id="basic-alert">
                    <div class="card-body">
                        ...
                        <table class="table main-table-reference mt-0 mb-0">
                            ...
                            <tr>
                                <td>optional4</td>
                                <td>the data which will need to send in optional 4, that data you will get under the optional4  of bill verification api</td>
                            </tr>
                    ...
                    <div class="card-footer">
                        <pre>GET: {{url('api/telecom/v1/payment')}}</pre>
                        <hr>
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>GET: {{url('api/telecom/v1/check-balance')}}</pre>
                        <hr>
                ...
                <div class="card" id="basic-alert">
                    ...
                    <div class="card-footer">
                        <pre>GET: {{url('api/telecom/v1/check-status')}}</pre>
                        <hr>
