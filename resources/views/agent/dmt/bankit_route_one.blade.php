...
@section('content')
    ...
    <script type="text/javascript">
        ...
        function getAllBeneficiary() {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/get-bankit-beneficiary')}}",
                data: dataString,
                success: function (msg) {
                    $(".loader").hide();
                    var html = "";
        ...
        function confirmSender() {
            ...
            var dataString = 'mobile_number=' + mobile_number + '&first_name=' + first_name + '&last_name=' + last_name + '&dateOfBirth=' + dateOfBirth + '&address=' + address + '&otp=' + otp + '&_token=' + token;
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/add-bankit-sender')}}",
                data: dataString,
                success: function (msg) {
                    $("#addSederBtn").show();
                    ...
                    if (msg.status == 'error') {
                        ...
                        $("#dateOfBirth_errors").text(msg.errors.dateOfBirth);
        ...
        function resendOtp() {
            ...
            var dateOfBirth = $("#dateOfBirth").val();
            var address = $("#address").val();
            var dataString = 'mobile_number=' + mobile_number + '&first_name=' + first_name + '&last_name=' + last_name + '&dateOfBirth=' + dateOfBirth + '&address=' + address + '&_token=' + token;
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/sender-resend-otp-bankit')}}",
                data: dataString,
                success: function (msg) {
                    $("#resendOtpBtn").show();
        ...
        function activateBeneficiary(id) {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/add-beneficiary-bankit')}}",
                data: dataString,
                success: function (msg) {
                    $(".loader").hide();
                    if (msg.status == 'error') {
        ...
        function verifyBeneficiary() {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/confirm-beneficiary-bankit')}}",
                data: dataString,
                success: function (msg) {
        ...
        function deleteBeneficiary(id) {
            ...
            if (result) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{url('agent/money/v1/delete-beneficiary-bankit')}}",
                    data: dataString,
                    success: function (msg) {
                        $(".loader").hide();
                        if (msg.status == 'success') {
        ...
        function confirmDeleteBeneficiary() {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/confirm-delete-beneficiary-bankit')}}",
                data: dataString,
                success: function (msg) {
        ...
        function accountVerify() {
            ...
            if (latitude && longitude) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{url('agent/money/v1/account-verify-bankit')}}",
                    data: dataString,
                    success: function (msg) {
                        getWalletBal();
                        $(".loader").hide();
        ...
        function viewTransfer(id) {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('agent/money/v1/view-account-transfer-bankit')}}",
                data: dataString,
                success: function (msg) {
                    $(".loader").hide();
                    if (msg.status == 'success') {
        ...
        function transferNow() {
            ...
            if (latitude && longitude) {
                ...
                $.ajax({
                    type: "POST",
                    url: "{{url('agent/money/v1/transfer-now-bankit')}}",
                    data: dataString,
                    success: function (msg) {
                        getWalletBal();
                        $("#transferBtn").show();
    ...
    @include('agent.dmt.bankit-common')
