                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <ul class="parsley-errors-list filled">
                                    <li class="parsley-required" id="device_errors"></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                                <button class="btn ripple btn-danger" type="button" id="scanBtns"
                                        onclick="scanBiometric()">
                                    Scan
                                </button>
                                <ul class="parsley-errors-list filled">
                                    <li class="parsley-required" id="BiometricDataPid_errors"></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" id="aadhaar_number" class="form-control" placeholder="Aadhaar number"
                                       maxlength="12">
                                <ul class="parsley-errors-list filled">
                                    <li class="parsley-required" id="aadhaar_number_errors"></li>
                                </ul>
                            </div>
                            <input type="hidden" id="BiometricDataPid">
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
...
<div class="modal  show" id="add-remitter-otp-model" data-toggle="modal">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content modal-content-demo">
            <div class="modal-header">
                <h6 class="modal-title">Register Remitter</h6>
                <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span
                        aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body">
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="name">Remitter OTP</label>
                                <input type="text" id="remitter_otp" class="form-control"
                                       placeholder="Enter Remitter OTP">
                                <ul class="parsley-errors-list filled">
                                    <li class="parsley-required" id="remitter_otp_errors"></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
                <button class="btn ripple btn-primary" type="button" id="remitterVerifyBtn"
                        onclick="verifyRemitterOtp()">Verify Remitter
                </button>
                <button class="btn btn-primary" type="button" id="remitterVerifyBtn_loader" disabled
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <div class="modal-body">
                ...
                <div class="row d-none" id="transactionOtpDiv">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label for="transaction_otp">Transaction Otp</label>
                            <input type="password" id="transaction_otp" class="form-control"
                                   placeholder="Transaction OTP">
                        </div>
                    </div>
                </div>
            </div>
