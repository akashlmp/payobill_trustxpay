                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                                <div class="form-row">
                                                    <div class="col-md-4 mb-4">
                                                        <label for="validationCustom01">Providers:</label>
                                                    ...
                                                    <div class="col-md-4 mb-4">
                                                        <label for="validationCustom02">Select Api</label>
                                                ...
                                                <button class="btn btn-primary"type="button" onclick="save_now()"><i class="fas fa-plus-square"></i> Add Now</button>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <span class="invalid-feedback d-block" id="view_amount_errors"></span>
