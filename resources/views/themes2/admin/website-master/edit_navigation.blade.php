...
@section('content')
    <script type="text/javascript">
        function update_navigation() {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('admin/update-navigation')}}",
                data: dataString,
                        ...
                        <div class="widget-content">
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" id="title" class="form-control" placeholder="Enter Title">{{ $title }}</textarea>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" id="keyword" class="form-control" placeholder="Enter Keyword">{{ $keyword }}</textarea>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <textarea type="text" id="description" class="form-control" placeholder="Enter Description">{{ $description }}</textarea>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="navigation_name" class="form-control" placeholder="Navigation Name" value="{{ $navigation_name }}">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="navigation_slug" class="form-control" placeholder="Slug (Navigation URL)" value="{{ $navigation_slug }}">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="type">
                                                    <option value="1" @if($type == 1) selected @endif>Header</option>
                                                    <option value="2" @if($type == 2) selected @endif>Footer</option>
                                                </select>
                                ...
                                <div class="widget-footer text-right">
                                    <button type="button" class="btn btn-primary mr-2"  onclick="update_navigation()">Submit</button>
