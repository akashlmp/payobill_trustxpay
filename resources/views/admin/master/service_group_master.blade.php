...
@section('content')
    ...
    <script type="text/javascript">
     function view_method(id) {
         ...
         $.ajax({
             type: "POST",
             url: "{{url('admin/view-service-group-master')}}",
             data: dataString,
             success: function (msg) {
                 $(".loader").hide();
                 if (msg.status == 'success') {
                     $("#view_id").val(msg.details.id);
                     $("#view_service_group_name").val(msg.details.service_group_name);
     ...
     function update_method() {
         ...
         var token = $("input[name=_token]").val();
         var id = $("#view_id").val();
         var group_name = $("#view_service_group_name").val();
         var status_id = $("#view_status_id").val();
         var dataString = 'id=' + id + '&group_name=' + group_name + '&status_id=' + status_id + '&_token=' + token;
         $.ajax({
             type: "POST",
             url: "{{url('admin/update-service-group-master')}}",
             data: dataString,
             success: function (msg) {
                 $("#update_btn").show();
                 ...
                 if (msg.status == 'success') {
                     ...
                     $("#view_service_group_name_errors").text(msg.errors.group_name);
     ...
     function add_method() {
         ...
         var dataString = 'group_name=' + group_name + '&_token=' + token;
         $.ajax({
             type: "POST",
             url: "{{url('admin/add-service-group-master')}}",
             data: dataString,
             success: function (msg) {
                 $("#create_btn").show();
                 ...
                 if (msg.status == 'success') {
                     ...
                     $("#group_name_errors").text(msg.errors.group_name);
                 }else{
                     swal("Faild", msg.message, "error");
                 }
             }
                ...
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            ...
                            <button class="btn btn-danger btn-sm" data-target="#add_method_model" data-toggle="modal">Add Service Group Master</button>
        ...
        <div class="modal-dialog modal-dialog-slideout" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Add Service Group Master</h6>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required" id="group_name_errors"></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="view_method_model" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel2" aria-hidden="true">
        <div class="modal-dialog modal-dialog-slideout" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h6 class="modal-title">Update Service Group</h6>
                    <button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">×</span></button>
                </div>
                <div class="modal-body">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="name">Service Group Name</label>
                                    <input type="text" id="view_service_group_name" class="form-control" placeholder="Group Name">
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required" id="view_service_group_name_errors"></li>
                                    </ul>
                                </div>
                            </div>
