...
@section('content')
    ...
    <script type="text/javascript">
        function saveCommission() {
            ...
            var provider_commission_type = $("#provider_commission_type").val();
            ...
            var dataString = 'provider_commission_type=' +provider_commission_type+ 'service_id=' + service_id + '&provider_id=' + provider_id + '&min_amount=' + min_amount + '&max_amount=' + max_amount + '&type=' + type + '&commission_type=' + commission_type + '&commission=' + commission + '&trans_type=' + trans_type + '&_token=' + token;
            $.ajax({
                type: "POST",
                url: "{{url('admin/store-api-commission-master')}}",
                data: dataString,
        ...
        function viewCommission(id) {
            ...
            $.ajax({
                type: "POST",
                url: "{{url('admin/view-api-commission-master')}}",
                data: dataString,
                success: function (msg) {
                    $(".loader").hide();
                    if (msg.status == 'success') {
        ...
        function updateComission() {
            ...
            var token = $("input[name=_token]").val();
            var id = $("#view_id").val();
            var provider_commission_type = $("#view_provider_commission_type").val();
            ...
            var dataString = 'id=' + id + '&provider_commission_type=' +provider_commission_type+ '&min_amount=' + min_amount + '&max_amount=' + max_amount + '&commission=' + commission + '&commission_type=' + commission_type + '&trans_type=' +trans_type+ '&type=' + type + '&_token=' + token;
            $.ajax({
                type: "POST",
                url: "{{url('admin/update-api-commission-master')}}",
                data: dataString,
                success: function (msg) {
                    $("#update_btn").show();
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-lg-4 col-md-8 form-group mg-b-0" id="providerCommissionType">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table text-md-nowrap" id="example1">
                                ...
                                <tbody>
                                @foreach($merchantApiCommission as $value)
                                    <tr>
                                        ...
                                        <td>
                                        @if($value->commission_type=='commission')
                                            Commission
                                        @else
                                            Charges
                                        @endif
                ...
                <div class="modal-body">
                    <div class="form-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" id="providerCommissionType">
                                <label class="form-label">API Provider</label>
                                <select class="form-control" id="view_provider_commission_type">
                                    <!-- <option value="1">Paysprint</option>
                                    <option value="2">Bankit</option> -->
