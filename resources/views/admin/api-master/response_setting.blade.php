                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required" id="status_value_errors"></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required" id="operator_ref_parameter_errors"></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required" id="under_value_errors"></li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required" id="view_status_parameter_errors"></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required" id="view_status_value_errors"></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required" id="view_operator_ref_parameter_errors"></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <ul class="parsley-errors-list filled">
                                        <li class="parsley-required" id="view_under_value_errors"></li>
                                    </ul>
                                </div>
                            </div>
