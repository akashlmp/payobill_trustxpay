...
@section('content')
    ...
    <script type="text/javascript">
        function save_commission() {
            ...
            var dataString = 'scheme_id=' + scheme_id + '&provider_id=' + provider_id + '&min_amount=' + min_amount + '&max_amount=' + max_amount + '&type=' + type + '&st=' + st + '&sd=' + sd + '&d=' + d + '&r=' + r + '&referral=' + referral + '&provider_commission_type=' + provider_commission_type + '&_token=' + token;
            $.ajax({
                type: "POST",
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-4 mg-t-10 mg-sm-t-25">
                                    <button class="btn btn-main-primary pd-x-20" type="button"
                                            onclick="save_commission()">Save Commission/Charge
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row row-sm">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between">
                            <h4 class="card-title mg-b-2 mt-2">Commission/Charge Slab</h4>
                            <i class="mdi mdi-dots-horizontal text-gray"></i>
                        </div>
                        <hr>
                    </div>
