            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{url('admin/income/my-income')}}" method="get">
                            <div class="row">
                        ...
                        <div class="table-responsive">
                            <table class="table text-md-nowrap" id="my_table">
                                ...
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">OP Bal</th>
                                    <th class="wd-15p border-bottom-0">Cr Amount</th>
                                    <th class="wd-15p border-bottom-0">Dr Amount</th>
                                    ...
                                    <th class="wd-15p border-bottom-0">CL Bal</th>
