                        ...
                        <form action="{{ $searchURL }}" method="get">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-8 form-group mg-b-0">
                                    ...
                                    <select class="form-control select2" id="download_optional1" name="status_id"
                                            style="width: 100%;">
                                        <option value="0" @if($status_id == 0) selected @endif> All Status</option>
                                        @foreach($status as $value)
                                            <option value="{{ $value->id }}"
                                                    @if($status_id == $value->id) selected @endif> {{ $value->status }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="table-responsive">
                            <table
                                ...
                                <tr>
                                    ...
                                    <th class="wd-15p border-bottom-0">Customer Charge</th>
                                    <th class="wd-15p border-bottom-0">Gst</th>
                                    <th class="wd-15p border-bottom-0">Profit</th>
                                    <th class="wd-15p border-bottom-0">TDS</th>
                                    <th class="wd-15p border-bottom-0">Net Commission</th>
